...
import { Settings as SettingsIcon, Palette, Bell, Lock, UserCircle, ShieldAlert } from "lucide-react";
        ...
        <Card className="shadow-lg rounded-xl">
          ...
          <CardContent className="space-y-6">
            <div className="space-y-2">
              ...
              <Input id="profile-name" defaultValue="Usuario Ejemplo" disabled />
               <p className="text-xs text-muted-foreground">Actualmente no se puede cambiar el nombre desde aquí.</p>
            </div>
            <div className="space-y-2">
              <Label htmlFor="profile-email">Correo Electrónico</Label>
              <Input id="profile-email" type="email" defaultValue="usuario@eduassist.com" disabled />
            </div>
