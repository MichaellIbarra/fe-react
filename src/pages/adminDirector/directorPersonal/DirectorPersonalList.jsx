                    ...
                    <div className="col-md-3">
                      <div className="form-group">
                        ...
                        <div className="d-block">
                          <Link to="/admin-director/director-personal/create" className="btn btn-primary">
                            ...
                            <tr key={user.keycloakId || user.id}>
                              ...
                              <td>
                                <div className="actions">
                                  {/* Ver detalles */}
                                  <Link
                                    to={`/admin-director/director-personal/${user.keycloakId}/view`}
                                  ...
                                  {/* Editar */}
                                  <Link
                                    to={`/admin-director/director-personal/${user.keycloakId}/edit`}
