...
const DirectorPersonalEdit = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      navigate('/admin-director/director-personal');
    } catch (err) {
            ...
            <div className="row">
              <div className="col-12">
                <div className="alert alert-danger" role="alert">
                  ...
                  <div className="mt-2">
                    <Link to="/admin-director/director-personal" className="btn btn-secondary">
                    ...
                    <div className="row">
                      <div className="col-12">
                        <div className="form-group mt-4">
                          ...
                          <Link
                            to="/admin-director/director-personal"
                          ...
                          <Link
                            to={`/admin-director/director-personal/${keycloakId}/view`}
