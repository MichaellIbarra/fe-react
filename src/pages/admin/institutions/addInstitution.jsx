...
const AddInstitution = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      setTimeout(() => {
        navigate('/institution'); // Redirigir a la lista de instituciones
      }, 2000);
    } catch (error) {
  ...
  return (
    <div>
      ...
      {showNotification && (
        ...
        >
          ...
          <div>
            ...
            <div>Institución creada correctamente</div>
          </div>
        </div>
      )}
      ...
      <Sidebar
        id="menu-item2"
        id1="menu-items2"
        activeClassName="add-institution"
      />
            ...
            <div className="row">
              <div className="col-sm-12">
                <ul className="breadcrumb">
                  ...
                  <li className="breadcrumb-item active">Agregar Institución</li>
                </ul>
              </div>
            </div>
          </div>
